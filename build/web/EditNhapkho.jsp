        ...
        <div class="grid">
          <nav class="header_nav">
            <ul class="header_list">
              <li class="nav_item">Sửa sản phẩm</li>
    ...
    <div class="content">
      <div class="sidebar-body w3-bar-block  w3-card " style="width:20%">
       ...
       <a href="managerNhapkho" class="w3-bar-item w3-button">Nhập kho</a>
        ...
        <form action="editNhapkho" method="post" style="background-color: #0984e3;height: 550px;margin-top: 50px;">
                   
                      <header>
                          <h2 style="text-align: center;">Sửa thông tin</h2>
                      </header>
            <input name="id" type="text" placeholder="Mã thuốc" value="${detail.mathuoc}"readonly required>
                        <input name="name" type="text" placeholder="Tên" value="${detail.name}" required>
                        <input name="img"type="text" placeholder="Ảnh" value="${detail.img}" required>
                        <input name="soluong" type="text" placeholder="Số lượng"value="${detail.soluong}" required>
                        <input name="date" type="text" placeholder="Ngày hết hạn"value="${detail.ngayHethan}" required>              
