    ...
    <div class="content">
      <div class="sidebar-body w3-bar-block  w3-card " style="width:20%">
       ...
       <c:if test="${sessionScope.acc.session == 1 || sessionScope.acc.session == 2}">
        ...
        <form action="edit" method="post" style="background-color: #0984e3;height: 550px;margin-top: 50px;">
            ...
            <input name="id" type="text" placeholder="Mã thuốc" value="${detail.mathuoc}"readonly required>
                        ...
                        <input name="price" type="text" placeholder="Giá thành" value="${detail.price}"required>
